...
var providerORM_1 = require("./services/orm/providerORM");
...
function testSaveIfNoExistsProvider() {
    return __awaiter(this, void 0, void 0, function () {
        var newProviders, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Initialize the data source
                    _a.sent();
                    return [4 /*yield*/, (0, providerORM_1.saveIfNoExistsProvider)(sampleProviders)];
                case 2:
                    newProviders = _a.sent();
                    // Log the results
                    console.log('New providers saved:', newProviders);
                    return [3 /*break*/, 6];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error testing saveIfNoExistsProvider:', error_1);
                    return [3 /*break*/, 6];
                case 4: 
