...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.birthDate = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _birthDate_initializers, void 0));
            this.tokens = (__runInitializers(this, _birthDate_extraInitializers), __runInitializers(this, _tokens_initializers, void 0));
            this.providers = (__runInitializers(this, _tokens_extraInitializers), __runInitializers(this, _providers_initializers, void 0));
            __runInitializers(this, _providers_extraInitializers);
        }
    ...
    (function () {
        ...
        _hashPassword_decorators = [(0, typeorm_1.BeforeUpdate)(), (0, typeorm_1.BeforeInsert)()];
        _birthDate_decorators = [(0, typeorm_1.Column)()];
        _tokens_decorators = [(0, typeorm_1.OneToMany)('UserToken', 'user')];
        _providers_decorators = [(0, typeorm_1.ManyToMany)('Provider')];
